...
class AlbumNode
{
   ...
   public ImageNode getPreviousMedia(String currentMediaName)
   {
    ...
    if (current != null && current.prev != null) 
    {
     ...
     {
        System.out.println("Media ordered by Date:");
        printAllMediaRecursive(imageHead);
        System.out.println(); 
     }

   // Sort tail to Head
        private void printAllMediaRecursive(ImageNode node) 
        {
        if (node == null) {
            return;
        }
        
        printAllMediaRecursive(node.next);
        
        if (!node.inRecyclebin) {
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
            System.out.println(node.imageName + "." + node.type + " (" + sdf.format(node.date) + ")");
        }
       }
}
        ...
        while (currentAlbumNode != null) 
        {
            ...
            while (currentImageNode != null) 
            {
                if (currentImageNode.type.equals(type)) 
                {
                    if(!albumHasMedia)
                    {
                        System.out.print(currentAlbumNode.album+ "       ");
                        //System.out.println("");
                        albumHasMedia = true;
                        found = true;
                    }
...
public class GalleryTool {
    public static void main(String []args) {
       ...
       System.out.println("             Gallery Tool");
        System.out.println();
         System.out.println();
        while(true) {
